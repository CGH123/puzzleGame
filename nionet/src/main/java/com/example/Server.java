...
//            this.serversocket3 = ServerSocketChannel.open();  
//            this.serversocket3.configureBlocking(false);  
//            this.serversocket3.socket().bind(new InetSocketAddress("localhost",this.port1));  
//            this.serversocket3.register(this.selector, SelectionKey.OP_ACCEPT); 
    ...
    public void accept(SelectionKey key) throws IOException{
        ...
        if(server.equals(serversocket1)){
            ...
            //OP_READ用于读取操作的操作集位  
            sk = clientchannel1.register(this.selector, SelectionKey.OP_READ);
...
//            if(buf.hasRemaining()) System.out.println("fuck");
