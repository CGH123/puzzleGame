 ...
 */
public class GameRoomTestActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.button_start:
                ...
                //目前用于跳转到游戏界面
                Intent intent = new Intent(GameRoomTestActivity.this, GameActivity.class);
